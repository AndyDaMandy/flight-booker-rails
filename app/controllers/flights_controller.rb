class FlightsController < ApplicationController
    def index
        ...
        @arrival_options = Flight.all.map{ |f| [ f.arrival_airport.airport_name, f.arrival_airport.id ]}.uniq
        @departure_options = Flight.all.map{ |f| [ f.departing_airport.airport_name, f.departing_airport.id ]}.uniq
        @departure_date = Flight.all.map{ |f| [ f.departure_date ] }.uniq
        @arrival_date = Flight.all.map{ |f| [ f.arrival_date ] }.uniq
